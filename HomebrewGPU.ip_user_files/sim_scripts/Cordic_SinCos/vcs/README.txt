...
#
# Generated by export_simulation on Tue Apr 27 00:53:00 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './Cordic_SinCos.sh' script.

./Cordic_SinCos.sh -reset_run
...
./Cordic_SinCos.sh -noclean_files

For more information on the script, please type './Cordic_SinCos.sh -help'.
